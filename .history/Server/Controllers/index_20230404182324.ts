...
export function DisplayDesktopPage(req: express.Request, res: express.Response, next: express.NextFunction)
{
    res.render('index', { title: 'Desktop App', page:'desktopapp', displayName: UserDisplayName(req)});
}
export function DisplayWebPage(req: express.Request, res: express.Response, next: express.NextFunction)
{
    res.render('index', { title: 'Web App', page:'desktopapp', displayName: UserDisplayName(req)});
}
