...
export function DisplayEditPage(req: express.Request, res: express.Response, next: express.NextFunction): void
{
   ...
   // instantiate a new contact object to edit
   ...
   Contact.findById(id, {}, {}, function(err, contactToEdit)
   {
     ...
     res.render('index', { title: 'Edit', page: 'edit', contact: conatctToEdit, displayName:  UserDisplayName(req) })
   });
...
export function ProcessEditPage(req: express.Request, res: express.Response, next: express.NextFunction): void 
{
   ...
   Contact.findById(id, {}, {}, function(err, contactToEdit)
   {
     ...
     // show the edit view with the data
     res.render('index', { title: 'Edit', page: 'edit', movie: contactToEdit, displayName:  UserDisplayName(req) })
   });
