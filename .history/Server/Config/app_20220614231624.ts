...
//authentication4 set up express session
app.use(session({
...
//authentication5 -set up flash
app.use(flash());

//authentication6-initialize passport and session
app.use(passport.initialize());
app.use(passport.session());

//authentication7- implement the auth strategy
passport.use(User.vvc);
